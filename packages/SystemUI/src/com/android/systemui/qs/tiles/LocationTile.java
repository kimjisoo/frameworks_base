    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        switch (currentMode) {
            case BATTERY_SAVING:
                ...
                state.label = mContext.getString(R.string.quick_settings_location_battery);
            ...
            case SENSORS_ONLY:
                ...
                state.label = mContext.getString(R.string.quick_settings_location_device);
                state.icon = mEnable;
                break;
            case HIGH_ACCURACY:
                state.value = true;
                state.contentDescription = mContext.getString(R.string.accessibility_quick_settings_location_high_accuracy);
                state.label = mContext.getString(R.string.quick_settings_location_high);
