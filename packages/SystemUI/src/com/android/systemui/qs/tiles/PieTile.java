...
public class PieTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (enable) {
            ...
            state.label = mContext.getString(R.string.quick_settings_pie_on);
        } else {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_pie_off);
            state.contentDescription =  mContext.getString(
                    R.string.quick_settings_pie_off);
            state.state = Tile.STATE_INACTIVE;
            state.label = mContext.getString(R.string.quick_settings_pie_off);
        }
    }
