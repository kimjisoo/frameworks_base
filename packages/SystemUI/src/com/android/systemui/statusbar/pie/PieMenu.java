...
public class PieMenu extends RelativeLayout {
    ...
    public PieMenu(Context context, PieController panel, StatusBar bar) {
        ...
        // settings intent
        mSettingsIntent = new Intent("android.settings.PIE_SETTINGS");
    ...
    private void getDimensions() {
        ...
        if (!mSettingsAttached) {
            mSettingsLogo.setImageResource(R.drawable.ic_lock_flashlight);
        ...
        mTogglePoint[mNumberOfSnapPoints++] = new SettingsPoint(mWidth / 2
            ...
            if (!mNotAttached) {
                mNOTLogo.setImageResource(R.drawable.ic_lock_power_off);
                addView(mNOTLogo);
                mNotAttached = true;
            }
        ...
        mPieBackgroundAnimator.setDuration(250);
        ...
        mPieFadeAnimator.setDuration(250);
        ...
        mRippleAnimator.setDuration(225);
        ...
        mSettingsToggleAnimator.setDuration(250);
    ...
    private void createSignalIcons() {
        ...
        // these got poorly aligned, so just hide them instead
/*            addView(mNetworkIcon);
    ...
    private void animateInRest(boolean fromTouch) {
        ...
        if (!mHasShown) {
            ...
            mSettingsToggleAnimator.setStartDelay(fromTouch ? 500 : 1000);
                ...
                if (mOpen) {
                    ...
                    for (int i = 0; i < mIconViews.size(); i++) { // Use only 1 loop because the size is the same
                        ...
                        try {
                            ...
                            mBar.performRemoveNotification(p.first);
